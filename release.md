...
Our release process is based upon [Github Actions](https://github.com/FedeDP/GhEnvSet/actions) and [goreleaser](https://github.com/goreleaser/goreleaser) tool for artifacts.
...
4. Once the CI has done its job, the tag is live on [Github](https://github.com/falcosecurity/ghenvset/releases) with the artifacts
